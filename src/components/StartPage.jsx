    ...
    return (
        <div>
            <section className="top center">
                <img src='/image/photo_header.png' alt="photo" class="top__photo" />
                <div className="top__box-title">
                    <h1 className="top__title">THE BRAND</h1>
                    <p className="top__text-title">OF LUXERIOUS <span class="top__selected-text">FASHION</span></p>
                </div>
            </section>
            <section className="offer center">
                <div className="offer__box">
                    <article className="offer__item">
                        <img className="offer__img" src='/image/item1.jpg' alt="item1" />
                        <div className="offer__text">
                            <p className="offer__text-title">30% OFF</p>
                            <h3 className="offer__title">FOR WOMEN</h3>
                        </div>
                    </article>

                    <article class="offer__item">
                        <img class="offer__img" src='/image/item2.jpg' alt="item2" />
                    ...
                    <article class="offer__item">
                        <img class="offer__img" src='/image/item3.jpg' alt="item3" />
                        <div class="offer__text">
                    ...
                    <article class="offer__item offer__item-big">
                        <img class="offer__img-wide" src='/image/item4.jpg' alt="item4" />
                        <div class="offer__text">
            ...
            <section class="products center">
                ...
                {/* <div class="product__box">
                    <div class="product">
                        <a href="#" class="product__image-hover">
                            ...
                            <img class="product__img" src="image/products/product-1.jpg" alt="product 1" />
                        </a>
                    ...
                    <div class="product">
                        <a href="#" class="product__image-hover">
                            ...
                            <img class="product__img" src="image/products/product-2.jpg" alt="product 2" />
                        </a>
                        <div class="product__content">
                            <a href="./pages/product.html" class="product__name">ELLERY X M'O CAPSULE</a>
                            <p class="product__text">Known for her sculptural takes on traditional tailoring, Australian
                    ...
                    <div class="product">
                        <a href="#" class="product__image-hover">
                            ...
                            <img class="product__img" src="image/products/product-3.jpg" alt="product 3" />
                        </a>
                        <div class="product__content">
                            <a href="./pages/product.html" class="product__name">ELLERY X M'O CAPSULE</a>
                            <p class="product__text">Known for her sculptural takes on traditional tailoring, Australian
                    ...
                    <div class="product">
                        <a href="#" class="product__image-hover">
                            ...
                            <img class="product__img" src="image/products/product-4.jpg" alt="product 4" />
                        </a>
                        <div class="product__content">
                            <a href="./pages/product.html" class="product__name">ELLERY X M'O CAPSULE</a>
                            <p class="product__text">Known for her sculptural takes on traditional tailoring, Australian
                    ...
                    <div class="product">
                        <a href="#" class="product__image-hover">
                            ...
                            <img class="product__img" src="image/products/product-5.jpg" alt="product 5" />
                        </a>
                        <div class="product__content">
                            <a href="./pages/product.html" class="product__name">ELLERY X M'O CAPSULE</a>
                            <p class="product__text">Known for her sculptural takes on traditional tailoring, Australian
                    ...
                    <div class="product">
                        <a href="#" class="product__image-hover">
                            ...
                            <img class="product__img" src="image/products/product-6.jpg" alt="product 6" />
                        </a>
                        <div class="product__content">
                            <a href="./pages/product.html" class="product__name">ELLERY X M'O CAPSULE</a>
                            <p class="product__text">Known for her sculptural takes on traditional tailoring, Australian
                ...
                <Link to="/Catalog"><button type="submit" class="products__button">Browse All
                    Product</button></Link>
            </section>
            <section class="feature center">
                <div class="feature__box">
                    <article class="feature__item">
                        ...
                        <p class="feature__item-text">Worldwide delivery on all. Authorit tively morph next-generation innov
                            tion
                            with
                            extensive models.</p>
                    </article>
